...
Opto Packet is structured like this:
    ...
    131     :    1*64    :   bools               :   B -- unsigned char
                                                        (and then broken up)
'''
...
def test():
    _sample = (
        b"\x02\\\x00\xa8B\xed\x19\x9a?Z\x1c\xacB\xb4\x00\x00B\xc9\x00\x00@\
        x82\x8f\\\xbcD"
        b"\x9b\xa6\x00\x00\x00\x00\x00\x00\x00\x00\xbd\x13t\xbc=\x13t\xbc\x00\
        x00\x00\x00"
        b"\x00\x00\x00\x00A?\x16\x87A@\xe7m\x00\x00\x00\x00\xba\xd1\xc0\
        x00<e`\x00\x00\x00"
        b"\x00\x009\xd1\x80\x00\xbf\x07\x93\xe0A\xcd1\x07A\xb8t\xab\x00\x00\
        x00\x00\x00\x00"
        b"\x00\x00A\xfc3?A\xd9\xba'\x00\x00\x00\x00\x00\x00\x00\x00\xbf\x80\
        x00\x00\xbf\x80"
        ...
        x00\x00\x00"
        b"\x00\x00\x00\x00\x00\x00\xc0\xcc\xc0\x0c\xc0\x00\x00\x00\xc0\xcc\
        xc0\x0c\xc0"
        b"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\
        x00\x00\x00"
        b"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\
